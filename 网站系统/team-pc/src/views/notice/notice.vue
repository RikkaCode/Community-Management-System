<template>
    <view @click="toDetails(item)" class="news-item" v-for="(item, index) in newList" :key="index">
        ...
        <view class="news-intr">
            ...
            <view class="news-info">
                <view class="news-time"><text>{{ item['createTime'] }}</text></view>
    ...
    <el-pagination style="margin-top: 15px" @size-change="sizeChange" @current-change="currentChange"
        :current-page.sync="parm.currentPage" :page-sizes="[1, 10, 20, 40, 80, 100]" :page-size="parm.pageSize"
